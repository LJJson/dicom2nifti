...
def img2nii(dcm_path, png_path, nii_path):
    ...
    sitk.WriteImage(nii, nii_path, detype=sitk.sitkUInt8)
...
file = '../data/4_579E62D1A4D3455DA93951801FA6F03A'
# CM_dirs = os.listdir(file)
file2= '../nii_output/STA44_mask.nii.gz'
for m in range(1, 2, 1):
    m = str(m)
    # file1=r"G:\prostate_data\USdcm\{}_US_dicom03.dcm".format(m.zfill(4))
    # file2 = r"G:\prostate_data\USnii_Normalize\{}_US_dicom03.nii.gz".format(m.zfill(4))
    png_path = r"../data/4_579E62D1A4D3455DA93951801FA6F03A_masks/neddle"
    # nii_path=r"G:\prostate_data\USMask_nii_Normalize\{}_US_dicom01.nii.gz".format(m.zfill(4))
    nii_path = "../nii_output/STA44_mask.nii.gz"
